// to manually test mongodb atlas database:
...
const password = process.argv[2] // f...

const url =
`mongodb+srv://thomastoumasu:${password}@cluster0.hmhtqmw.mongodb.net/testBloglist?retryWrites=true&w=majority&appName=Cluster0`
